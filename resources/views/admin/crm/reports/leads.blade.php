...
@section('title', 'Leads Report — UperLevel')

@section('content-body')
<div class="page-head">
    <div>
        <h2>Leads Report</h2>
        <p><a href="{{ route('admin.crm.overview.index') }}" style="color:var(--primary-dark);">← Back to Leads Overview</a> — {{ $start->format('M j, Y') }} – {{ $end->format('M j, Y') }}.</p>
    </div>
</div>
...
@include('admin.hr.reports._report-table', [
    ...
    'headers' => $headers,
    'rows' => $rows,
    'exportRoute' => 'admin.crm.reports.export',
