...
<div class="panel" style="max-width:560px;">
    ...
    <div style="padding:18px 20px;">
        <p style="font-size:13px;color:var(--ink-soft);margin:0 0 14px;">
            Already have your leads in a spreadsheet from another system? Download the template below, fill it in, and upload it here.
            Only the <strong>Name</strong> column is required — everything else is optional.
        </p>

        <a href="{{ route('admin.crm.leads.import.template') }}" class="btn btn-ghost" style="margin-bottom:18px;">⬇ Download sample template</a>
        ...
        <form method="POST" action="{{ route('admin.crm.leads.import.store') }}" enctype="multipart/form-data">
            ...
            <p class="f-hint">Your import is saved immediately — no approval needed for admin uploads.</p>
