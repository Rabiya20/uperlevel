...
@section('title', 'Edit Holiday — UperLevel')
...
<form method="POST" action="{{ route('admin.company.holidays.update', $holiday) }}">
    @csrf
    @method('PUT')
    @include('admin.company.holidays._form', ['holiday' => $holiday])
</form>
@endsection
