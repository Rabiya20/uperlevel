...
@section('title', 'Performance Report — UperLevel')
...
<div class="panel" style="padding:14px 20px;margin-bottom:18px;background:var(--primary-soft);border-color:var(--primary-soft);">
    <span style="color:var(--primary-dark);font-size:12.5px;">Derived from attendance records — there's no dedicated performance review module yet, so this reflects attendance rate, punctuality and average hours only.</span>
</div>
...
@include('admin.hr.reports._report-table', [
    ...
    'headers' => $headers,
    'rows' => $rows,
    'exportRoute' => 'admin.hr.reports.performance.export',
