...
@section('title', 'Add Payroll Component — UperLevel')
...
<form method="POST" action="{{ route('admin.hr.payroll-components.store') }}">
    @csrf
    @include('admin.hr.payroll-components._form', ['component' => null])
</form>
@endsection
